        ...
        <Card>
            ...
            <template #content>
                <div class="my-8">
                    ...
                    <div>
                        <DataTable :value="invoice.invoiceActivities" size="large" :rowHover="true" :lazy="true"
                        ...
                        <DataTable :value="invoice.invoiceAdditionals" size="large" :rowHover="true" :lazy="true"
                            :rowStyle="({ status }) => status == 'APPROVE' ? { background: '#79bed9', color: 'white' } : status == 'REJECT' ? { background: '#d98494', color: 'white' } : {}"
                            v-else>
                            <Column field="bapNumber" header="No. BAP/SPK"></Column>
                            <Column field="activity.name" header="Aktifitas"></Column>
                    ...
                    <div class="flex items-end flex-col gap-4 my-10">
                        <div class="min-w-[400px] max-w-[400px] grid grid-cols-2 border-b p-2">
                            ...
                            <span class="font-bold text-[14px]">{{ invoice?.invoiceActivities?.length > 0 ?
                                formatRupiah(totalActivities) : formatRupiah(totalAdditionals)
                                }}</span>
                        </div>
                        <div class="min-w-[400px] max-w-[400px] grid grid-cols-2 border-b p-2">
                        ...
                        <div class="min-w-[400px] max-w-[400px] grid grid-cols-2 border-b p-2">
                            ...
                            <span class="font-bold text-[14px]">{{ formatRupiah(totalPembayaran) }}</span>
                        </div>
                    </div>
                </div>
            </template>
