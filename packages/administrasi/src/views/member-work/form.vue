    ...
    <div class="flex justify-center items-center">
        ...
        <div class="max-w-[60%] min-w-[70%]">
            ...
            <div class="card relative" v-for="(activity, i) in formRef.activities" :key="i">
                ...
                <div class="w-10 h-10 rounded-full text-white flex justify-center items-center absolute top-[-10px] right-[-5px] cursor-pointer" @click="handlePlusMinusActivity(i)" :class="i == 0 ? 'bg-primary' : 'bg-red-500'">
