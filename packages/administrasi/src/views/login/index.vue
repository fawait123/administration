...
const handleLogin = async () => {
    try {
        ...
        toast.add({ severity: 'error', summary: 'Opps!', detail: ResponseMessage.message(error) });
    }
};
</script>
        ...
        <div class="flex flex-col items-center justify-center">
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                    ...
                    <form>
                        <CustomInputGroup placeholder="Masukan Username" label="Username" v-model="loginRef.username" :invalid="!!getError('username')" :error-message="getError('username')" class-name="mb-8" />

                        <CustomInputGroup placeholder="Masukan Password" label="Password" type="password" v-model="loginRef.password" :invalid="!!getError('password')" :error-message="getError('password')" class-name="mb-8" />
